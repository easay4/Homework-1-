...
# Lab 05 
# Lab Section: 40
# Sources, people worked with, help given to: https://www.youtube.com/watch?v=9LgyKiq_hU0
# I used https://www.youtube.com/watch?v=9LgyKiq_hU0. This is a video on loops from khan academy. I was still a little bit confused about loops and ths video helped me. 
# I felt myself leaning on the TA's too much and not really understanding the content, However this lab helped me a bunch.
# "note" is meant for me. I want to use this as an example for my other labs.
...
# I used the Youtube video on loops to help me with this problem.
for hot in max_temps:
    if max_temp < hot:
        max_temp = hot

for cold in min_temps:
    if min_temp > cold:
        min_temp = cold 
...
# *note* could have made this into a single loop by just ading an elif instead of another if. Shown in next problem 
...
# The video also helped me here.
for num in numbers:
    if num > 0:
        pos_count += 1 # *note* += 1 = Times 1 
    elif num < 0:
        neg_count += 1
    else:
        zero_count += 1 
...
for sum in numbers:
    if sum > 0:
        pos_sum += sum  # *note* the loop runs all the numbers less than 0 to get sum 
    elif sum < 0:
        neg_sum += sum
